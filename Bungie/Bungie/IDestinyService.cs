namespace Bungie
{
    ...
    public interface IDestinyService
    {
        ...
        //Task<GetAccountResponse> GetAccountSummary(MembershipType membershipType, long membershipId, bool? definitions = null);
        Task<GetAccountSummaryResponse> GetAccountSummary(MembershipType membershipType, long membershipId, bool? definitions = null);
        Task<GetActivitiesResponse> GetActivities(MembershipType membershipType, long membershipId, long characterId);
        ...
        Task<GetStatsForCharacter> GetStatsForCharacter(MembershipType membershipType, long membershipId, long characterId, PeriodType? periodType = null, DateTime? monthStart = null, DateTime? monthEnd = null, DateTime? dayStart = null, DateTime? dayEnd = null);

namespace Bungie
{
    ...
    public class DestinyService : BungieService, IDestinyService
    {
        ...
        /// </remarks>
        [Route("Stats/ActivityHistory/{membershipType}/{membershipId}/{characterId}/?mode=PrivateMatchesAll&definitions=true")]
        public Task<GetActivitiesResponse> GetActivities(MembershipType membershipType, long membershipId, long characterId)
        {
            var model = new
            {
                membershipType,
        ...
        public Task<GetStatsForCharacter> GetStatsForCharacter(MembershipType membershipType, long membershipId, long characterId, PeriodType? periodType = null, DateTime? monthStart = null, DateTime? monthEnd = null, DateTime? dayStart = null, DateTime? dayEnd = null)
        {
            var model = new
            {
                membershipType,
